from app.talana_kombat_jrpg.constants import ENERGY, ARNOLD_TALADOKEN_ENERGY, ARNOLD_TALADOKEN_COMBINATION, ARNOLD_REMUYUKEN_COMBINATION, \
    ARNOLD_REMUYUKEN_ENERGY, BASIC_ATTACK, REMUYUKEN_NAME, TALADOKEN_NAME
...
class Arnaldor(Player):
    ...
    def get_moves(self, moves):
        ...
        if ARNOLD_TALADOKEN_COMBINATION in moves_message:
            return GenerateMoves.special(self.name, moves_message, ARNOLD_TALADOKEN_COMBINATION,
                                         ARNOLD_TALADOKEN_ENERGY, TALADOKEN_NAME)

        elif ARNOLD_REMUYUKEN_COMBINATION in moves_message:
            return GenerateMoves.special(self.name, moves_message, ARNOLD_REMUYUKEN_COMBINATION,
                                         ARNOLD_REMUYUKEN_ENERGY, REMUYUKEN_NAME)
